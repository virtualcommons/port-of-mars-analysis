...
survey_cultural_renames <- tibble::tribble(
  ...
  "cultural__risk_preference", "Q12", "How do you see yourself: are you generally a person who is fully prepared to take risks or do you try to avoid taking risks? Please set the slider on the gauge, where the value 0 means: â€˜not at all willing to take risksâ€™ and the value 10 means: â€˜very willing to take risksâ€™.â€",
  "cultural__situation1", "Q5", "Situation 1",
  "cultural__situation2", "Q7", "Situation 2",
  "cultural__situation3", "Q8", "Situation 3",
  "cultural__situation4", "Q9", "Situation 4",
  "cultural__situation5", "Q10", "Situation 5",
  "cultural__situation6", "Q11", "Situation 6",
  ...
  "cultural__$choice1", "Q20", "Would you rather receive 100 dollars today or 153.8 dollars in 12 months?",
  "cultural__$choice2", "Q22", "Would you rather receive 100 dollars today or 125.4 dollars in 12 months?",
  "cultural__$choice3", "Q23", "Would you rather receive 100 dollars today or 112.4 dollars in 12 months?",
  "cultural__$choice4", "Q24", "Would you rather receive 100 dollars today or 106.1 dollars in 12 months?",
  "cultural__$choice5", "Q25", "Would you rather receive 100 dollars today or 103.0 dollars in 12 months?",
  "cultural__$choice6", "Q26", "Would you rather receive 100 dollars today or 109.2 dollars in 12 months?",
  "cultural__$choice7", "Q27", "Would you rather receive 100 dollars today or 118.8 dollars in 12 months?",
  "cultural__$choice8", "Q28", "Would you rather receive 100 dollars today or 122.1 dollars in 12 months?",
  "cultural__$choice9", "Q29", "Would you rather receive 100 dollars today or 115.6 dollars in 12 months?",
  "cultural__$choice10", "Q30", "Would you rather receive 100 dollars today or 139.2 dollars in 12 months?",
  "cultural__$choice11", "Q31", "Would you rather receive 100 dollars today or 132.3 dollars in 12 months?",
  "cultural__$choice12", "Q32", "Would you rather receive 100 dollars today or 128.8 dollars in 12 months?",
  "cultural__$choice13", "Q33", "Would you rather receive 100 dollars today or 135.7 dollars in 12 months?",
  "cultural__$choice14", "Q34", "Would you rather receive 100 dollars today or 146.4 dollars in 12 months?",
  "cultural__$choice15", "Q35", "Would you rather receive 100 dollars today or 142.8 dollars in 12 months?",
  "cultural__$choice16", "Q36", "Would you rather receive 100 dollars today or 150.1 dollars in 12 months?",
  "cultural__$choice17", "Q37", "Would you rather receive 100 dollars today or 185.0 dollars in 12 months?",
  "cultural__$choice18", "Q38", "Would you rather receive 100 dollars today or 201.6 dollars in 12 months?",
  "cultural__$choice19", "Q39", "Would you rather receive 100 dollars today or 193.2 dollars in 12 months?",
  "cultural__$choice20", "Q40", "Would you rather receive 100 dollars today or 197.4 dollars in 12 months?",
  "cultural__$choice21", "Q41", "Would you rather receive 100 dollars today or 189.1 dollars in 12 months?",
  "cultural__$choice22", "Q42", "Would you rather receive 100 dollars today or 210.3 dollars in 12 months?",
  "cultural__$choice23", "Q43", "Would you rather receive 100 dollars today or 214.6 dollars in 12 months?",
  "cultural__$choice24", "Q44", "Would you rather receive 100 dollars today or 205.9 dollars in 12 months?",
  "cultural__$choice25", "Q45", "Would you rather receive 100 dollars today or 169.0 dollars in 12 months?",
  "cultural__$choice26", "Q46", "Would you rather receive 100 dollars today or 161.3 dollars in 12 months?",
  "cultural__$choice27", "Q47", "Would you rather receive 100 dollars today or 157.5 dollars in 12 months?",
  "cultural__$choice28", "Q48", ". Would you rather receive 100 dollars today or 165.1 dollars in 12 months?",
  "cultural__$choice29", "Q49", "Would you rather receive 100 dollars today or 176.9 dollars in 12 months?",
  "cultural__$choice30", "Q50", "Would you rather receive 100 dollars today or 172.9 dollars in 12 months?",
  "cultural__$choice31", "Q51", "Would you rather receive 100 dollars today or 180.9 dollars in 12 months?",
  "cultural__characteristic1", "Q52_1", "For each of the statements shown, please indicate whether or not
...
course, click on the options in between, if you fall between the extremes - I consider how things might be in the future, and try to influence those things with my day to day behavior.",
  "cultural__characteristic2", "Q52_2", "For each of the statements shown, please indicate whether or not
the statement is characteristic of you. If the statement is extremely uncharacteristic of you (not at all like you) click on the left button; if the statement is extremely characteristic of
you (very much like you) click on the right button. And, of
course, click on the options in between, if you fall between the extremes - Often I engage in a particular behavior in order to achieve outcomes that may not result for many years.",
  "cultural__characteristic3", "Q52_3", "For each of the statements shown, please indicate whether or not
the statement is characteristic of you. If the statement is extremely uncharacteristic of you (not at all like you) click on the left button; if the statement is extremely characteristic of
you (very much like you) click on the right button. And, of
course, click on the options in between, if you fall between the extremes - I only act to satisfy immediate concerns, figuring the future will take care of itself.",
  "cultural__characteristic4", "Q52_4", "For each of the statements shown, please indicate whether or not
the statement is characteristic of you. If the statement is extremely uncharacteristic of you (not at all like you) click on the left button; if the statement is extremely characteristic of
you (very much like you) click on the right button. And, of
course, click on the options in between, if you fall between the extremes - My behavior is only influenced by the immediate (i.e., a matter of days or weeks) outcomes of my actions.",
  "cultural__characteristic5", "Q52_5", "For each of the statements shown, please indicate whether or not
the statement is characteristic of you. If the statement is extremely uncharacteristic of you (not at all like you) click on the left button; if the statement is extremely characteristic of
you (very much like you) click on the right button. And, of
course, click on the options in between, if you fall between the extremes - My convenience is a big factor in the decisions I make or the actions I take.",
  "cultural__characteristic6", "Q52_6", "For each of the statements shown, please indicate whether or not
the statement is characteristic of you. If the statement is extremely uncharacteristic of you (not at all like you) click on the left button; if the statement is extremely characteristic of
you (very much like you) click on the right button. And, of
course, click on the options in between, if you fall between the extremes - I am willing to sacrifice my immediate happiness or well-being in order to achieve future outcomes.",
  "cultural__characteristic7", "Q52_7", "For each of the statements shown, please indicate whether or not
the statement is characteristic of you. If the statement is extremely uncharacteristic of you (not at all like you) click on the left button; if the statement is extremely characteristic of
you (very much like you) click on the right button. And, of
course, click on the options in between, if you fall between the extremes - I think it is important to take warnings about negative outcomes seriously even if the negative outcome will not occur for many years.",
  "cultural__characteristic8", "Q52_8", "For each of the statements shown, please indicate whether or not
the statement is characteristic of you. If the statement is extremely uncharacteristic of you (not at all like you) click on the left button; if the statement is extremely characteristic of
you (very much like you) click on the right button. And, of
course, click on the options in between, if you fall between the extremes - I think it is more important to perform a behavior with important distant consequences than a behavior with less important immediate consequences",
  "cultural__characteristic9", "Q52_9", "For each of the statements shown, please indicate whether or not
the statement is characteristic of you. If the statement is extremely uncharacteristic of you (not at all like you) click on the left button; if the statement is extremely characteristic of
you (very much like you) click on the right button. And, of
course, click on the options in between, if you fall between the extremes - I generally ignore warnings about possible future problems because I think the problems will be resolved before they reach crisis level.",
  "cultural__characteristic10", "Q52_10", "For each of the statements shown, please indicate whether or not
the statement is characteristic of you. If the statement is extremely uncharacteristic of you (not at all like you) click on the left button; if the statement is extremely characteristic of
you (very much like you) click on the right button. And, of
course, click on the options in between, if you fall between the extremes - I think that sacrificing now is usually unnecessary since future outcomes can be dealt with at a later time.",
  "cultural__characteristic11", "Q52_11", "For each of the statements shown, please indicate whether or not
the statement is characteristic of you. If the statement is extremely uncharacteristic of you (not at all like you) click on the left button; if the statement is extremely characteristic of
you (very much like you) click on the right button. And, of
course, click on the options in between, if you fall between the extremes - I only act to satisfy immediate concerns, figuring that I will take care of future problems that may occur at a later date.",
  "cultural__characteristic12", "Q52_12", "For each of the statements shown, please indicate whether or not
the statement is characteristic of you. If the statement is extremely uncharacteristic of you (not at all like you) click on the left button; if the statement is extremely characteristic of
you (very much like you) click on the right button. And, of
course, click on the options in between, if you fall between the extremes - Since my day-to-day work has specific outcomes, it is more important to me than behavior that has distant outcomes.",
  "cultural__characteristic13", "Q52_13", "For each of the statements shown, please indicate whether or not
the statement is characteristic of you. If the statement is extremely uncharacteristic of you (not at all like you) click on the left button; if the statement is extremely characteristic of
you (very much like you) click on the right button. And, of
course, click on the options in between, if you fall between the extremes - When I make a decision, I think about how it might affect me in the future.",
  "cultural__characteristic14", "Q52_14", "For each of the statements shown, please indicate whether or not
the statement is characteristic of you. If the statement is extremely uncharacteristic of you (not at all like you) click on the left button; if the statement is extremely characteristic of
you (very much like you) click on the right button. And, of
...
The use of fossil fuels and deforestations lead to about 11.5 Gigaton Carbon (GtC) in recent years. Natural processes gradually remove CO2 from the atmosphere, for example due to plant life, currently about 4 GtC a year. To avoid a dangerous climate change, we need to reduce CO2 emissions. Given the information in this question, what is the maximum amount of emissions from human activities we can allow to start reducing CO2 concentration in the atmosphere.",
  "cultural__studentdebt", "Q54_1", "John successfully graduated from ASU. He has student debt totaling $50,000, with an interest rate of 5%. John wants to pay of his student debt in 20 years. What does John need to pay each year to pay off the student loan. - $"
) %>% dplyr::mutate(origin = "cultural survey")
...
survey_round_begin_renames <- tibble::tribble(
  ...
  "pre__i_am_a_leader", "Q2_1", "Please rate the extent to which you agree or disagree with each of the following statements. - I am a leader",
  "pre__i_see_myself_as_a_leader", "Q2_2", "Please rate the extent to which you agree or disagree with each of the following statements. - I see myself as a leader",
  "pre__describe_leader", "Q2_3", "Please rate the extent to which you agree or disagree with each of the following statements. - If I had to describe myself to others I would include the word â€œleader.â€",
  "pre__seen_as_leader", "Q2_4", "Please rate the extent to which you agree or disagree with each of the following statements. - I prefer being seen by others as a leader.",
  "pre__change_crisis_situations", "Q2_5", "Please rate the extent to which you agree or disagree with each of the following statements. - I will change how I handle crisis situations.",
  "pre__change_stress", "Q2_6", "Please rate the extent to which you agree or disagree with each of the following statements. - I will change how I handle stress.",
  "pre__solve_problems_creatively", "Q2_7", "Please rate the extent to which you agree or disagree with each of the following statements. - I will solve problems creatively.",
  "pre__change_deals_in_uncertain_situations", "Q2_8", "Please rate the extent to which you agree or disagree with each of the following statements. - I will change how I deal with uncertain situations.",
  "pre__try_other_ways_to_play", "Q2_9", "Please rate the extent to which you agree or disagree with each of the following statements. - I will try other ways to play the game.",
  "pre__adapt_to_my_teammates_play", "Q2_10", "Please rate the extent to which you agree or disagree with each of the following statements. - I will adapt to my teammates' play.",
  "pre__takeaways_from_previous_round", "Q3", "What are some of your takeaways from the previous round playing this game?",
  "pre__will_you_do_something_different", "Q4", "Will you do something different in this round? Why or why not? If so, what will you change?"
) %>% dplyr::mutate(origin = "pre game survey") 
